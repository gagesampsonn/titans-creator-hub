...
export const courseModules: CourseModule[] = [
  ...
  },
  {
    ...
    videos: [
      ...
      {
        id: 'cc-3',
        title: 'Opus Clips: Turn Longform into Product Plug Videos',
        description: 'Learn how to use Opus Clips to turn longform content into short clips perfect for TikTok Shop product plug style videos. Generate 10-50 clips from podcasts, interviews, or any long video and use them to promote products.',
        duration: '3:00',
        ...
        topics: [
          ...
          { label: 'Longform to Short Clips' },
          { label: 'Product Plug Video Style' },
          { label: 'Adjusting Aspect Ratios' },
        ],
        keyTakeaways: [
          'Turn any longform video into 10-50 short clips',
          'Create product plug style content faster',
          'Repurpose podcasts and interviews for TikTok Shop',
        ],
        difficulty: 'beginner',
