        ...
        <div className="prose prose-invert max-w-none">
          ...
          <section className="mb-10">
            <p className="text-text-secondary leading-relaxed">
              Titans ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our website and services, including the Titans Creator Hub at https://www.titansagency.co (the "Platform").
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="bg-titan-surface border border-titan-border rounded-lg p-5">
              ...
              <a
                href="mailto:Tiktoktitansmanagement@gmail.com?subject=Privacy%20inquiry"
                className="text-accent-teal hover:text-accent-teal/80 text-sm transition-colors break-all"
              >
