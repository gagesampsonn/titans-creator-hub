        ...
        <div className="prose prose-invert max-w-none">
          ...
          <section className="mb-10">
            <p className="text-text-secondary leading-relaxed">
              Welcome to Titans! These Terms of Service ("Terms") govern your use of the Titans Creator Hub and related services at https://www.titansagency.co (the "Platform"). By accessing or using our Platform, you agree to be bound by these Terms.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="bg-titan-surface border border-titan-border rounded-lg p-5">
              ...
              <a
                href="mailto:Tiktoktitansmanagement@gmail.com?subject=Terms%20of%20Service%20inquiry"
