              ...
              <div className="bg-titan-surface rounded border border-titan-border p-5">
                ...
                <div className="mb-5 relative">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="px-2 py-0.5 bg-titan-border text-text-muted text-[10px] font-medium rounded-full">
                      Upload only for now
                    </span>
                  </div>
                  ...
                  <p className="text-[10px] text-text-muted mt-1.5 flex items-center gap-1">
                    ...
                    Audits use the video file you upload above. Paste-by-URL is planned for a later release.
                  </p>
                </div>
